    ...
    <div className="min-h-screen bg-bg p-8">
      <div className="max-w-7xl mx-auto">
        <div className="bg-surface rounded-3xl p-8 shadow-sm">
          <div className="mb-8">
            <h1 className="text-3xl font-serif text-brand mb-2">Rotación de Certificados</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {certs.map(cert => (
              <div key={cert.id} className="bg-bg/50 rounded-2xl overflow-hidden border border-border/10 flex flex-col">
                <div className="aspect-square relative bg-border/5 flex items-center justify-center p-2 overflow-hidden">
                ...
                <div className="p-4 bg-surface flex flex-col items-center justify-between flex-1 border-t border-border/10">
                  <p className="text-[10px] text-text/40 mb-3 truncate w-full text-center" title={cert.filename}>
                    {cert.filename}
                  </p>
