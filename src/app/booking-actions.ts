...
export async function requestAppointment(input: {
  ...
  try {
    ...
    // Construir la fecha/hora a partir de año-mes-día locales
    ...
    // Conciliación de paciente: buscar por teléfono y clínica
    ...
    if (existingPatient) {
      ...
      // Crear pre-perfil automáticamente dentro de la clínica
